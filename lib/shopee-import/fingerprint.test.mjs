...
test("match digest distinguishes commission values that differ below two decimals", () => {
  const precise = digestInput({
    matched: [matched(11, "2026-09-01", "22985.94997")],
    unmatched: [],
    matchedCommission: new Decimal("22985.94997"),
    unmatchedCommission: new Decimal(0),
  });
  const rounded = digestInput({
    matched: [matched(11, "2026-09-01", "22985.95000")],
    unmatched: [],
    matchedCommission: new Decimal("22985.95000"),
    unmatchedCommission: new Decimal(0),
  });

  assert.notEqual(buildMatchDigest(2, precise), buildMatchDigest(2, rounded));
});
