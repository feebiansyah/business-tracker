...
test("generated schema exposes WL daily spend", () => {
  assert.equal(Prisma.ModelName.MetaAccountDailySpend, "MetaAccountDailySpend");
  assert.equal(Prisma.MetaAccountDailySpendScalarFieldEnum.metaAccountId, "metaAccountId");
  assert.equal(Prisma.MetaAccountDailySpendScalarFieldEnum.spend, "spend");
  assert.match(modelFieldDefinition("MetaAccountDailySpend", "spend"), /@db\.Decimal\(18, 2\)/);
});
