...
test("planner retains initial history and routine D-1 correction without semantic-version branching", () => {
  const initial = planCampaignCoverage([{ id: 9, startDate: "2026-09-01", historySyncedThrough: null }], "2026-09-09");
  assert.equal(initial.chunks[0].since, "2026-09-01");
  const routine = planCampaignCoverage([{ id: 9, startDate: "2026-09-01", historySyncedThrough: "2026-09-09" }], "2026-09-10");
