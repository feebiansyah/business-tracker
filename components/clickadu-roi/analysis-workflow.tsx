...
export function ClickaduAnalysisWorkflow({ shopeeAccountId, configs, connected }: { shopeeAccountId: number; configs: ClickaduAnalysisConfig[]; connected: boolean }) {
