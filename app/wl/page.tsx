...
export default async function AllWlPage({ searchParams }: { searchParams: Promise<{ connection?: string | string[] }> }) {
  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4"><div><p className="text-sm font-medium text-slate-500">Master data</p><h2 className="text-2xl font-semibold tracking-tight text-slate-950">Semua WL</h2></div><MetaSyncButton /></div>
